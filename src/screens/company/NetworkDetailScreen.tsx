...
type DetailType = 'stockist' | 'dealer';
...
const stockistDetail: DetailData = {
  id: 'stockist-a',
  type: 'stockist',
...
const mockNetworkDetailApi = async (
  id: string,
  type: DetailType,
): Promise<DetailData> => {
...
const ProfileCard = ({data}: {data: DetailData}) => {
  return (
...
const PaymentCard = ({data}: {data: DetailData}) => {
  return (
...
const IncentiveCard = ({data}: {data: DetailData}) => {
  return (
    <View style={styles.halfCard}>
...
const TimelineCard = ({data}: {data: DetailData}) => {
  return (
    <View style={styles.halfCard}>
...
const NetworkDetailScreen = () => {
  ...
  useEffect(() => {
    mockNetworkDetailApi(routeId, routeType).then(response => {
      setData(response);
